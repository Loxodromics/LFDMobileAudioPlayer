...
public class BackgroundAudioService extends MediaBrowserServiceCompat  implements MediaPlayer.OnCompletionListener, AudioManager.OnAudioFocusChangeListener  {
    ...
    private String mTitle = "Loading ...",mArtist="",mAlbumurl="",mURL="",mNotification="Android Player";
    ...
    private void showPlayingNotification() {
        if(mAlbumBitMap == null) mAlbumBitMap = BitmapFactory.decodeResource(getResources(), R.drawable.icon);
    ...
    private Bitmap bitMapDownloader(String url){
        ...
        if(mIcon_val == null) mIcon_val = BitmapFactory.decodeResource(getResources(), R.drawable.icon);
        return mIcon_val;
    }
